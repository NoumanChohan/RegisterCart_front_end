        ...
        <Box height='90vh' width='100vw' display='flex' justifyContent='center' alignItems='center'>
          <Box height='90%' width='90%' display='flex' justifyContent='space-around' alignItems='center'>
            ...
            <Box height='90%' width='45%' display='flex' flexDirection='column' justifyContent='space-around' alignItems='center'>
              <Typography fontWeight='bold' fontSize='30px'>Sign Up</Typography>
              <TextField variant='filled' label='User Name' name='name' value={values.name} helperText={errors.name} onChange={handleChange} sx={{ width: '70%' }}></TextField>
              <TextField variant='filled' label='Email' name='email' value={values.email} helperText={errors.email} onChange={handleChange} sx={{ width: '70%' }}></TextField>
              <TextField variant='filled' label='Password' type='password' name='password' value={values.password} helperText={errors.password} onChange={handleChange} sx={{ width: '70%' }}></TextField>
              <TextField variant='filled' label='Confirm Password' type='password' name='confirmPassword' value={values.confirmPassword} helperText={errors.confirmPassword} onChange={handleChange} sx={{ width: '70%' }}></TextField>
